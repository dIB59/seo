...
export default function Home() {
  ...
  const handleExport = async (analysisId: string, format: 'pdf' | 'csv' | 'json') => {
    try {
      ...
      // You could show a success message or open the file
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Comprehensive SEO analysis for your website. Get detailed insights on performance,
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {/* Empty State */}
          {recentAnalyses.length === 0 && !currentAnalysis && !isLoading && (
