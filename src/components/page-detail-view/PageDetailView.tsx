        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500 ease-out pb-20">
            ...
            <Tabs defaultValue="meta" className="space-y-6">
                <div className="sticky top-[88px] z-10 py-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                    <TabsList className="w-full h-11 p-1 bg-muted/30 border border-border/40 rounded-lg backdrop-blur text-muted-foreground grid grid-cols-5 gap-1">
                        {[
                ...
                <div className="min-h-[400px] animate-in fade-in slide-in-from-bottom-1 duration-300 delay-75">
                    <TabsContent value="meta" className="mt-0 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"><MetaTab page={page} /></TabsContent>
                    <TabsContent value="seo-audit" className="mt-0 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"><SeoAuditTab page={page} /></TabsContent>
                    <TabsContent value="headings" className="mt-0 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"><HeadingsTab headings={page.headings || []} /></TabsContent>
                    <TabsContent value="images" className="mt-0 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"><ImagesTab images={page.images || []} /></TabsContent>
                    <TabsContent value="links" className="mt-0 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"><LinksTab links={page.detailed_links || []} /></TabsContent>
                </div>
            </Tabs>
            ...
            <div className="fixed bottom-0 left-0 right-0 py-2 border-t border-border/40 bg-background/80 backdrop-blur-md flex items-center justify-center text-[11px] text-muted-foreground/70 pointer-events-none z-50">
                <div className="flex items-center gap-4 px-4 py-1.5 rounded-full bg-background/50 border border-border/20 shadow-sm backdrop-blur-sm">
                    <div className="flex items-center gap-1.5">
                        <kbd className="inline-flex h-5 items-center justify-center rounded border border-border bg-muted/50 px-1.5 font-mono text-[10px] font-medium text-muted-foreground shadow-[0_1px_0_0_rgba(0,0,0,0.05)]">←</kbd>
                        <kbd className="inline-flex h-5 items-center justify-center rounded border border-border bg-muted/50 px-1.5 font-mono text-[10px] font-medium text-muted-foreground shadow-[0_1px_0_0_rgba(0,0,0,0.05)]">→</kbd>
                        <span>Navigate</span>
                    </div>
                    <div className="w-px h-3 bg-border/50" />
                    <div className="flex items-center gap-1.5">
                        <kbd className="inline-flex h-5 items-center justify-center rounded border border-border bg-muted/50 px-1.5 font-mono text-[10px] font-medium text-muted-foreground shadow-[0_1px_0_0_rgba(0,0,0,0.05)]">Esc</kbd>
                        <span>Back</span>
                    </div>
                </div>
            </div>
