                ...
                <Tabs defaultValue="issues" className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
                    <div className="flex items-center justify-between mb-4">
                        <TabsList className="bg-muted/30 border border-border/40 p-1 h-auto backdrop-blur-sm shadow-sm">
                            <TabsTrigger value="issues" className="gap-2 px-4 py-2 data-[state=active]:bg-background data-[state=active]:shadow-sm transition-all duration-300">
                                <AlertTriangle className="h-4 w-4" />
                                Issues
                            </TabsTrigger>
                            <TabsTrigger value="pages" className="gap-2 px-4 py-2 data-[state=active]:bg-background data-[state=active]:shadow-sm transition-all duration-300">
                                <FileText className="h-4 w-4" />
                                Pages
                            </TabsTrigger>
                            <TabsTrigger value="graph" className="gap-2 px-4 py-2 data-[state=active]:bg-background data-[state=active]:shadow-sm transition-all duration-300">
                                <Network className="h-4 w-4" />
                                Site Graph
                            </TabsTrigger>
                            <TabsTrigger value="overview" className="gap-2 px-4 py-2 data-[state=active]:bg-background data-[state=active]:shadow-sm transition-all duration-300">
                    ...
                    <div className="mt-4 min-h-[500px] bg-card/20 rounded-xl border border-white/5 backdrop-blur-sm p-1">
