...
export const HomeHeader = React.memo(function HomeHeader({ isValidating, onRefresh }: HeaderProps) {
    ...
    <div className="flex flex-col gap-1 mb-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          >
            <RefreshCw className={`h-3.5 w-3.5 mr-2 ${isValidating ? "animate-spin" : ""}`} />
            Sync
          </Button>
          <Button
            variant="outline"
