...
import StatusBadge from "@/src/app/analysis/details/_components/atoms/StatusBadge";
import type { ImageElement } from "@/src/api/analysis";
                          ...
                          <TooltipContent>
                            <p className="max-w-md break-all font-mono text-xs">
                              {shouldOfferPreview(image.src)
                                ? `${truncate(image.src, 600)} (truncated)`
                                : image.src}
                            </p>
                          </TooltipContent>
                        </Tooltip>
