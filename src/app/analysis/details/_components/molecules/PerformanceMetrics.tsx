          ...
          return (
            <TableRow key={key}>
              ...
              <TableCell className="text-right">
                <Badge
                  variant="outline"
                  className={`text-xs ${colorClass === "text-success" ? "bg-success/15 text-success border-success/20" : colorClass === "text-warning" ? "bg-warning/15 text-warning border-warning/20" : colorClass === "text-destructive" ? "bg-destructive/15 text-destructive border-destructive/20" : ""}`}
                >
