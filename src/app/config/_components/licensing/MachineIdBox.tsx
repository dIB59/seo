        ...
        <div className="space-y-3 group">
            <div className="flex items-end justify-between px-1">
                ...
                <Button
                    ...
                    className="h-6 px-2 text-[10px] font-bold uppercase tracking-tighter opacity-0 group-hover:opacity-100 transition-opacity hover:bg-primary/5 hover:text-primary"
                >
            ...
            >
                ...
                <span className="text-[8px] font-sans font-black uppercase tracking-tighter text-primary opacity-0 group-hover/id:opacity-100 transition-opacity ml-4 shrink-0">Click to Copy</span>
            </div>
        </div>
    );
}
