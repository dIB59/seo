    ...
    <div className="space-y-3 group">
      <div className="px-1">
        <div className="space-y-0.5">
          <h4 className="text-[9px] font-bold text-muted-foreground/50 uppercase tracking-widest">
            Device Identifier
          </h4>
          <p className="text-[10px] text-muted-foreground/30 font-medium">
            Hardware bound to this installation
          </p>
        </div>
      </div>
      ...
      >
        <span className="truncate opacity-60 group-hover/id:opacity-100 transition-opacity">
        ...
        <div className="flex items-center gap-3 ml-4 shrink-0 transition-all opacity-0 group-hover/id:opacity-100">
          <span className="text-[8px] font-sans font-black uppercase tracking-tighter text-primary">
            Click to Copy
          </span>
